    ...
    <div class="">
      ...
      <v-card class="px-4 pt-1 ma-2" v-if="!toggle" >
        ...
        <v-row>
          ...
          <v-col cols="6" >
            <v-text-field v-model="user.age" label="Age" variant="outlined" type="number" hint="Current age of apprecant" color="green" density="compact"></v-text-field>
          </v-col>
          <v-col cols="6" >
...
<v-btn class="ma-6 text-none" color="green"  :disabled="!(processing=='predicting')" loading v-show="(processing=='predicting')">Predicing results..</v-btn>
      ...
      <v-card class="mx-2" v-if="toggle" ><v-file-input @change="onFileChange" variant="outlined" label="Select the file"  class="mt-2 mx-4" color="green" density="compact" prepend-icon="" >
